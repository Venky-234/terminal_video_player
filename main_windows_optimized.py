## optimized version of the file that uses numba for JIT compilation
import cv2
import os
import time
import keyboard 
...
@njit
def generate_string(resized) -> int:
...
def img_to_ascii(img):
    ...
    return generate_string(resized)
